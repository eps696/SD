...
def get_args():
    ...
    parser.add_argument('-o', '--out_dir',  default="_out", help="directory in which to place generated images and a log of prompts and seeds")
    ...
    parser.add_argument('-nz', '--noiser',  default='default', help='default, karras, exponential, vp')
